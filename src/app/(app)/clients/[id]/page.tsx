      ...
      <div className="flex items-start gap-5 mb-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1 text-sm text-slate-500">
            ...
            {client.email && (
              <><span>·</span><span>{client.email}</span></>
            )}
            {client.phone && (
          ...
          {client.notes && (
            <p className="text-sm text-slate-500 mt-2 italic">{client.notes}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="stat-card">
          ...
          <p className="text-2xl font-bold text-emerald-600">
            {client.quotes.filter((q) => q.status === "accepted").length}
          </p>
        </div>
        <div className="stat-card">
              ...
              <div key={q.id} className="px-6 py-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    {q.estimatedHours && (
                      <p className="text-xs text-slate-400 mt-1">Est. {q.estimatedHours}h</p>
                    )}
                  </div>
