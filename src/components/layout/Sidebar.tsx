...
import { LayoutDashboard, Users, PlusCircle, ClipboardList, DollarSign, Zap, LogOut } from "lucide-react";
  ...
  return (
    <aside className="w-60 flex-shrink-0 bg-slate-900 flex flex-col h-screen">
      ...
      <div className="px-3 py-4 border-t border-slate-800 space-y-1">
        ...
        <p className="text-slate-600 text-xs px-3">Frank Solutions · v1.0</p>
      </div>
    </aside>
  );
}
